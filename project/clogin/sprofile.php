...
<body>
    ...
    <form>
        ...
        <fieldset>
            ...
            <input readonly type="text" id="roll" name="roll" value=<?php echo $roll; ?> required>
    ...
    <select id="os" name="os">
        ...
        <fieldset>
            ...
            <input readonly type="number" step="any" id="Xth" name="Xth" min="0" max="100" required value=<?php echo $Xth; ?>>
            <label for="XIth">11th(percentage):</label>
            <input readonly type="number" step="any" id="XIth" name="XIth" min="0" max="100" value=<?php echo $XIth; ?> required>

            <label for="XIIth">12th(percentage):</label>
            <input readonly type="number" step="any" id="XIIth" name="XIIth" min="0" max="100" value=<?php echo $XIIth; ?> required>
            <label for="csem">Current Sem:</label>
            <input readonly type="number" id="csem" name="csem" min="1" max="8" value=<?php echo $csem; ?> required>

            <label for="sem1">1st sem(CPI):</label>
            <input readonly type="number" step="any" id="sem1" name="sem1" min="0" max="10" value=<?php echo $sem1; ?> required>


            <label for="sem2">2nd sem(CPI):</label>
            <input readonly type="number" step="any" id="sem2" name="sem2" min="0" max="10" value=<?php echo $sem2; ?> required>

            <label for="sem3">3rd sem(CPI):</label>
            <input readonly type="number" step="any" id="sem3" name="sem3" min="0" max="10" value=<?php echo $sem3; ?> required>

            <label for="sem4">4th sem(CPI):</label>
            <input readonly type="number" step="any" id="sem4" name="sem4" min="0" max="10" value=<?php echo $sem4; ?> required>

            <label for="sem5">5th sem(CPI):</label>
            <input readonly type="number" step="any" id="sem5" name="sem5" min="0" max="10" value=<?php echo $sem5; ?> required>

            <label for="sem6">6th sem(CPI):</label>
            <input readonly type="number" step="any" id="sem6" name="sem6" min="0" max="10" value=<?php echo $sem6; ?> required>

            <label for="sem7">7th sem(CPI):</label>
            <input readonly type="number" step="any" id="sem7" name="sem7" min="0" max="10" value=<?php echo $sem7; ?> required>

            <label for="sem8">8th sem(CPI):</label>
            <input readonly type="number" step="any" id="sem8" name="sem8" min="0" max="10" value=<?php echo $sem8; ?> required>

            <label for="ccpi">Current CPI:</label>
            <input readonly type="number" step="any" id="ccpi" name="ccpi" min="0" max="10" value=<?php echo $ccpi; ?> required>
            ...
            <fieldset>
                ...
                <textarea readonly id="aoi" name="aoi">
                <?php echo $aoi; ?>
                </textarea>
